...
def actorcritic_dist_torch(cfg, env_folder, rank, size, 
                           client, old_posit, initZ,
                           reset_array, reset_array_raw, level_name, crash_threshold):
            ...
            if automate:
                ...
                if cfg.mode == 'train':
                    ...
                    if switch_env:
                        ...
                        #print(np.shape(current_state[name_agent]))
                        ...
                        # print('Took Action')
                        new_state[name_agent] = agent[name_agent].get_state() # new_state is an numpy float array
                        # print('got state')
                        ...
                        #     print (tag_mem, gpu_memory[i], tag_util, gpu_utilization[i])
                        # print('Memory in GB: ', sys_memory)
